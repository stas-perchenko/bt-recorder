...
public class GainUpRestCommand extends BaseRestCommand {
    private static final String COMMAND_NAME = "gainup";

    public GainUpRestCommand(@NonNull BtDataTransceiver dataTransceiver) {
