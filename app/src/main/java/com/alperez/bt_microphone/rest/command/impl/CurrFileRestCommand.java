...
public class CurrFileRestCommand extends BaseRestCommand {
    private static final String COMMAND_NAME = "current";

    public CurrFileRestCommand(@NonNull BtDataTransceiver dataTransceiver) {
