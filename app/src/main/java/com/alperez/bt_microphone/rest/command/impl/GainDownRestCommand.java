...
public class GainDownRestCommand extends BaseRestCommand {
    private static final String COMMAND_NAME = "gaindown";

    public GainDownRestCommand(@NonNull BtDataTransceiver dataTransceiver) {
