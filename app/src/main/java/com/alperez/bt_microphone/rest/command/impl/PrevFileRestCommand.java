...
public class PrevFileRestCommand extends BaseRestCommand {
    private static final String COMMAND_NAME = "previous";

    public PrevFileRestCommand(@NonNull BtDataTransceiver dataTransceiver) {
