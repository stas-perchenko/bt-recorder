...
public class PhantomOnRestCommand extends BaseRestCommand {
    private static final String COMMAND_NAME = "phantomon";

    public PhantomOnRestCommand(@NonNull BtDataTransceiver dataTransceiver) {
