...
public class FastForwardRestCommand extends BaseRestCommand {
    private static final String COMMAND_NAME = "fforward";

    int seconds;

    public FastForwardRestCommand(@NonNull BtDataTransceiver dataTransceiver) {
